                        ...
                        <div className="col-md-5">
                            <div style={formWrap}>
                                <iframe
                                    ...
                                    frameBorder="0"
                                    className="iframes" src={config.iframeUrl2+"/RegisterLive?url=https://cors-anywhere.herokuapp.com/https://exiniti.blob.core.windows.net/public/accuindex.css&ref="+props.referral}/>
                            </div>
                        </div>
                    </div>
                </div>
