                        ...
                        <div className="col-md-5">
                            <div style={formWrap}>
                                <iframe
                                    ...
                                    frameBorder="0"
                                    className="iframes" src="https://cp-new-ui.azurewebsites.net/RegisterDemo?url=https://cors-anywhere.herokuapp.com/https://exiniti.blob.core.windows.net/public/accuindex.css"/>
                            </div>
                        </div>
                    </div>
                </div>
